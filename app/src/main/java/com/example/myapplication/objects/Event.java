...
public class Event implements Serializable, Parcelable {
    ...
    public void drawLottery() {
        if (waitingList == null || waitingList.getList().isEmpty()) {
            Log.w("drawLottery", "The waiting list is empty or not initialized. No lottery will be performed.");
            return; // Gracefully exit if the waiting list is empty
        }

        if (maxCapacity == null || maxCapacity <= 0) {
            Log.w("drawLottery", "Invalid maxCapacity value. No lottery will be performed.");
            return; // Gracefully exit if maxCapacity is invalid
        }
        ...
        Log.d("drawLottery", "Lottery completed. Selected users: " + lottery);
    }
